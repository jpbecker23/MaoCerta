        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedName = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnderecoServico = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ValorProposto = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
                    Status = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Observacoes = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    CodigoVerificacao = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SolicitacoesServico_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SolicitacoesServico_Profissionais_ProfissionalId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClienteId = table.Column<int>(type: "integer", nullable: false),
                    ProfissionalId = table.Column<int>(type: "integer", nullable: false),
                    SolicitacaoServicoId = table.Column<int>(type: "integer", nullable: false),
                    NotaPreco = table.Column<int>(type: "integer", nullable: false),
                    NotaQualidade = table.Column<int>(type: "integer", nullable: false),
                    NotaTempoExecucao = table.Column<int>(type: "integer", nullable: false),
                    NotaComunicacao = table.Column<int>(type: "integer", nullable: false),
                    NotaProfissionalismo = table.Column<int>(type: "integer", nullable: false),
                    Comentario = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    PontosPositivos = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    PontosNegativos = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Avaliacoes_SolicitacoesServico_SolicitacaoServicoId",
                        column: x => x.SolicitacaoServicoId,
                        principalTable: "SolicitacoesServico",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.InsertData(
                table: "Categorias",
                columns: new[] { "Id", "Ativa", "Descricao", "Icone", "Nome" },
                values: new object[,]
                {
                    { 1, true, "Serviços de manutenção e reparo de chuveiros", "🚿", "Manutenção de Chuveiros" },
                    { 2, true, "Serviços de jardinagem e paisagismo", "🌱", "Jardinagem" },
                    { 3, true, "Serviços de limpeza doméstica", "🧹", "Limpeza Residencial" },
                    { 4, true, "Serviços elétricos residenciais", "⚡", "Elétrica" },
                    { 5, true, "Serviços hidráulicos e encanamento", "🔧", "Hidráulica" },
                    { 6, true, "Serviços de pintura residencial", "🎨", "Pintura" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Avaliacoes_ClienteId_ProfissionalId_SolicitacaoServicoId",
                table: "Avaliacoes",
                columns: new[] { "ClienteId", "ProfissionalId", "SolicitacaoServicoId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Avaliacoes_SolicitacaoServicoId",
                table: "Avaliacoes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SolicitacoesServico_ClienteId",
                table: "SolicitacoesServico",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_SolicitacoesServico_ProfissionalId",
                table: "SolicitacoesServico",
                column: "ProfissionalId");
        }
